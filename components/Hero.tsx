...
import {
  Box, Button, Container, InputLabel,
  Link, Stack, styled, TextField, Typography,
} from '@mui/material'
      ...
      sx={
        (theme) => ({
          ...
          backgroundImage: `radial-gradient(
            ellipse 80% 50% at 50% -20%, hsl(210, 100%, 90%), transparent
          )`,
          ...theme.applyStyles('dark', {
            backgroundImage: `radial-gradient(
              ellipse 80% 50% at 50% -20%, hsl(210, 100%, 16%), transparent)
            `,
          }),
        })
      }
